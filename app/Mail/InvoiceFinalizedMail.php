...
class InvoiceFinalizedMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Invoice Ready for Payment - ' . ($this->invoice->number ?? 'INV-' . strtoupper(substr($this->invoice->id, 0, 8))),
        );
    }
